...
DataProcessor::DataProcessor()
    : last_time_(0), surge_position_(0), surge_velocity_(0),
      ...
      sway_acceleration_(0), heave_position_(0), heave_velocity_(0),
      heave_acceleration_(0), yaw_angle_(0), yaw_rate_(0), yaw_acceleration_(0),
      yaw_integral_(0), pitch_angle_(0), pitch_rate_(0), pitch_acceleration_(0),
...
void DataProcessor::processAccelerometer(int16_t ax, int16_t ay, int16_t az) {
  ...
  float dt =
      (current_time - last_time_) / 1000.0; // Convert milliseconds to seconds
